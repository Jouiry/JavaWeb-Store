...
<body>
						...
						<tr>
							...
							<td height="10" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									<a href="${pageContext.request.contextPath }/admin/OrderServlet?op=delOrder&oid=${order.oid}" onclick="return del()">删除</a> |
									<a href="${pageContext.request.contextPath }/admin/OrderServlet?op=orderDetail&oid=${order.oid}">查看</a>
								</div>
							</td>
					</tr>
					</c:forEach>
							...
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/OrderServlet?op=findAllOrder&num=1">首页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/OrderServlet?op=findAllOrder&num=${page.prevPageNum}">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/OrderServlet?op=findAllOrder&num=${page.nextPageNum}">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/admin/OrderServlet?op=findAllOrder&num=${page.totalPageNum }">尾页</a></span>
										</div>
									</td>
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			window.location.href = "${pageContext.request.contextPath }/admin/OrderServlet?op=findAllOrder&num="
					+ num;
