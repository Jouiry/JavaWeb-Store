...
<body>
	<form method="post" action="${pageContext.request.contextPath }/admin/ProductServlet?op=findAllProduct&num=1" >
						...
						<td height="24" bgcolor="#353c44"><table width="100%"
							...
							<tr class="STYLE10" >
								...
								<c:forEach items="${categories}" var="category">
									<option value="${category.cid}" <c:if test="${category.cname =='无'}">selected</c:if>>${category.cname}</option>
								</c:forEach>	
							    </select>
