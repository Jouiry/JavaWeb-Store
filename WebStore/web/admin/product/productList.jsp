...
<body>
						...
						<tr>
							...
							<td height="20" bgcolor="#FFFFFF">
								<div align="center" class="STYLE21">
									<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=deleteOne&pid=${product.pid}" onclick="return del()">删除</a> |
									<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findProduct&pid=${product.pid}">编辑</a>
								</div>
							</td>
					</tr>
					</c:forEach>
							...
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findAllProduct&num=1&pid=${pid}&pname=${pname}&cid=${cid}&maxprice=${maxprice}&minprice=${minprice}">首页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findAllProduct&num=${page.prevPageNum}&pid=${pid}&pname=${pname}&cid=${cid}&maxprice=${maxprice}&minprice=${minprice}">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findAllProduct&num=${page.nextPageNum}&pid=${pid}&pname=${pname}&cid=${cid}&maxprice=${maxprice}&minprice=${minprice}">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/admin/ProductServlet?op=findAllProduct&num=${page.totalPageNum}&pid=${pid}&pname=${pname}&cid=${cid}&maxprice=${maxprice}&minprice=${minprice}">尾页</a></span>
										</div>
									</td>
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			window.location.href = "${pageContext.request.contextPath }/admin/ProductServlet?op=findAllProduct&num="
