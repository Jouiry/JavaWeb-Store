...
<div  style="height:100%;">
  <ul id="navigation">
    <li> <a class="head">商品管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath}/admin/ProductServlet?op=getCategories" target="rightFrame">添加商品</a></li>
        <li><a href="${pageContext.request.contextPath}/admin/ProductServlet?op=findAllProduct&num=1" target="rightFrame">查看/修改商品</a></li>
        <li><a href="${pageContext.request.contextPath}/admin/ProductServlet?op=searchProduct" target="rightFrame">搜索商品</a></li>
      </ul>
    </li>
    <li> <a class="head">分类管理</a>
      <ul>
        ...
        <li><a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&num=1" target="rightFrame">查看/删除分类</a></li>
      </ul>
    </li>
    <li> <a class="head">订单管理</a>
      <ul>
        <li><a href="${pageContext.request.contextPath }/admin/OrderServlet?op=findAllOrder&num=1" target="rightFrame">查询/修改订单</a></li>
      </ul>
    </li>
    ...
    <li> <a class="head">注册用户管理</a>
      <ul>
        ...
        <li><a href="${pageContext.request.contextPath }/admin/UserServlet?op=findAllUser&num=1" target="rightFrame">查看普通注册用户</a></li>
      </ul>
    </li>
