...
<body>
				...
				<c:forEach items="${categories}" var="category" varStatus="status">
					<tr>
						...
						<td height="20" bgcolor="#FFFFFF" class="STYLE6">
							<div align="center">
								<span class="STYLE19">${status.count}</span>
							</div>
						</td>
						...
						<td height="20" bgcolor="#FFFFFF">
							<div align="center" class="STYLE21">
								<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=deleteOne&cid=${category.cid}" onclick="return del()">删除</a> |
								<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findCategoryByUpdate&cid=${category.cid}&cname=${category.cname}">编辑</a>
							</div>
						</td>
					</tr>
				</c:forEach>
							...
							<table width="312" border="0" align="right" cellpadding="0" cellspacing="0">
								<tr>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&num=1">首页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&num=${page.prevPageNum}">上一页</a>
											</span>
										</div>
									</td>
									<td width="49"><span class="STYLE22">
									    <div align="center">
											<span class="STYLE22">
											<a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&num=${page.nextPageNum}">下一页</a>
											</span>
										</div>
									</td>
									<td width="49">
										<div align="center">
											<span class="STYLE22"><a href="${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&num=${page.totalPageNum }">尾页</a></span>
										</div>
									</td>
	...
	<script type="text/javascript">
        ...
        function jump() {
            ...
            window.location.href = "${pageContext.request.contextPath }/admin/CategoryServlet?op=findAllCategory&num="
                + num;
