...
<body>
					...
					<c:forEach items="${admins}" var="admin">
						...
						<td height="20" bgcolor="#FFFFFF">
							<div align="center" class="STYLE21">
								<a href="${pageContext.request.contextPath }/admin/AdminServlet?op=deleteOne&aid=${admin.aid}" onclick="return del()">删除</a>
	...
	<script type="text/javascript">
		...
		function jump() {
			...
			window.location.href = "${pageContext.request.contextPath }/admin/AdminServlet?op=findAllAdmin&num="
					+ num;
